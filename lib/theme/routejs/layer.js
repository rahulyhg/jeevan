define(["jquery", "knockout", "eventEmitter", "datepicker", "moment"], function ($, ko, EventEmitter) {
    ...
    Layer.prototype.editSettings = function () {
        this.settings2edit({
            ...
            startdate: ko.observable(this.startdate()),
            enddate: ko.observable(this.enddate()),
    ...
    Layer.prototype.saveSettings = function () {
        ...
        this.startdate(this.settings2edit().startdate());
        this.enddate(this.settings2edit().enddate());
