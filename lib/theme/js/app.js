		...
		$.ajax({
	        ...
	        success: function (data) {
	        	 ...
	        	 if (data.status == "success") {
	        		/*var times = data.disabled_time_intervals;
	        		
	        		 times.forEach(function(element) {
	        			 disableHours =  [moment().hour(element.start.hour).minutes(element.start.minutes), moment().hour(element.end.hour).minutes(element.end.minutes)];
