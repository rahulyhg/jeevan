			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 wayoflife_content chakra-content text-center" id="right">
					...
					<div id="body" class="common_view">
						<img src="<?php echo skin_url(); ?>img/Body.png" alt="first chakra">
						<h3>body</h3>
					...
					<div id="soul" class="common_view">
						<img src="<?php echo skin_url(); ?>img/soul.png" alt="first chakra">
						<h3>soul</h3>
						<div class="clearfix"></div>
					...
					<div id="mind" class="common_view">
						<img src="<?php echo skin_url(); ?>img/mind.png" alt="first chakra">
						<h3>MIND</h3>
						<div class="clearfix"></div>
					...
					<div id="marriageproblem" class="common_view">
						<img src="<?php echo skin_url(); ?>img/marriage-prob.png" alt="second chakra">
					...
					<div id="healthproblem" class="common_view">
						<img src="<?php echo skin_url(); ?>img/health-prob.png" alt="second chakra">
					...
					<div id="careerproblem" class="common_view">
						<img src="<?php echo skin_url(); ?>img/career-problem.png" alt="second chakra">
					...
					<div id="businessproblem" class="common_view">
						<img src="<?php echo skin_url(); ?>img/Bussiness-Prob.png" alt="second chakra">
					...
					<div id="earth" class="common_view">
						<img src="<?php echo skin_url(); ?>img/Earth.png" alt="">
						<h3>earth</h3>
						<div class="clearfix"></div>
					...
					<div id="water" class="common_view">
						<img src="<?php echo skin_url(); ?>img/water.png" alt="">
						<h3>water</h3>
						<div class="clearfix"></div>
					...
					<div id="air" class="common_view">
						<img src="<?php echo skin_url(); ?>img/Air.png" alt="">
						<h3>air</h3>
						<div class="clearfix"></div>
					...
					<div id="fire" class="common_view">
						<img src="<?php echo skin_url(); ?>img/Fire.png" alt="">
						<h3>fire</h3>
						<div class="clearfix"></div>
					...
					<div id="ether" class="common_view">
						<img src="<?php echo skin_url(); ?>img/ether.png" alt="">
						<h3>ether</h3>
						<div class="clearfix"></div>
					...
					<div id="twelvenakhatras" class="common_view">
						<img src="<?php echo skin_url(); ?>img/12-rasi.png" alt="">
