...
<div class="panel-group" id="accordion">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#body" class="expand">Body<div class="right-arrow">+</div></a>
        </h4>
      </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#mind" class="expand">Mind<div class="right-arrow">+</div></a>
        </h4>
      </div>
      <div id="mind" class="panel-collapse collapse">
        <div class="panel-body"><p>We all know that brain exists inside our body and functions as a central processing unit carrying out all tasks that is required to keep us alive. If that is so what is mind, who controls it and what is its role? For long, this question has been reverberating among all those who have started their journey towards self-realization and also among those who are focused to achieve higher goals in their lives. Such people normally claim that they are focusing or finding ways to tame their minds and not their brains. Well, that is why Jeevanacharya propagates towards a sound mind. According to him mind is where emotions, consciousness, and memories, judgmental and thinking abilities are created and are unique to each and every person while brain is considered as a physical entity inside our body that is controlled by the mind. Now you can understand why each individual behaves differently even if exposed to the same kind of a situation. You can also relate brain to a vessel containing a substance called mind. To take good decisions both the brain and mind need to be pure and healthy, even if anyone of the two entities becomes unhealthy or corrupted the whole objective to excel in life would be lost.</p>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#marriageproblem" class="expand">Marriage Problems<div class="right-arrow">+</div></a>
        </h4>
      </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#career_problem" class="expand">Career Problems<div class="right-arrow">+</div></a>
        </h4>
      </div>
      <div id="career_problem" class="panel-collapse collapse">
        <div class="panel-body"><p>Career aspirations are different for different people for certain people it might lie on a prestigious title while for another it could be the amount of money they would like to earn as a salary and perks. A successful career depends on various factors such as the inter-relationship with the sub-ordinates, boss, departments, clients and collegeaus based on personal values, characteristics, attitude, wisdom and skill of the self and also of the persons we are dealing with.</p>
        <p>So what makes marriages go sour?  Actually there are many factors that are believed to have an impact on the harmony of marriage. Few of the main reasons are given below.</p>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#earth" class="expand">Earth<div class="right-arrow">+</div></a>
        </h4>
      </div>
      <div id="earth" class="panel-collapse collapse">
        <div class="panel-body">
        	<div class="col-xs-6">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#ether" class="expand">Ether<div class="right-arrow">+</div></a>
        </h4>
      </div>
      <div id="ether" class="panel-collapse collapse">
        <div class="panel-body"><p>Out of the five elements sky is the only element that is universal to all zodiac signs. It is said to be the unending region that comprises of our solar system and other galaxies unknown to mankind. Hence is also considered as the mystic element.</p>
        </div>
      </div>
    </div>
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#twelve_nakhatras" class="expand">Twelve Nakshatras<div class="right-arrow">+</div></a>
        </h4>
      </div>
