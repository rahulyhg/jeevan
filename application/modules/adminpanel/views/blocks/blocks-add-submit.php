						...
						<?php /**<div class="form-group">
							...
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo form_input('params[css_id]',set_value('params[css_id]'),' class="form-control"  ');?></div></div>
						</div>
						
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-2 control-label"><?php echo get_label('block_element_class');?></label>
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo form_input('params[css_class]',set_value('params[css_class]'),' class="form-control"  ');?></div></div>
						</div>**/?>
