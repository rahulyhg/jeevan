			...
			<div class="col-xs-12">
                ...
                <?php echo form_open_multipart(admin_url().$module.'/add',' class="form-horizontal" id="common_form" ' );?>
						...
						<div class="form-group">
							...
							<?php echo form_input('appointment_date', set_value('appointment_date'),' class="form-control availablelocation_datepicker"');?>
						...
						<div class="form-group">
							...
							<?php echo form_input('appointment_start_time', set_value('appointment_start_time'),' class="form-control "'); ?>
						...
						<div class="form-group">
							...
							<?php  echo form_input('appointment_end_time', set_value('appointment_end_time'),' class="form-control appointment_end_time"');?>
							<span class="input-group-addon">
						        <span class="glyphicon glyphicon-time"></span>
						    </span>
							</div></div>
  ...
  var startTime =  $('.appointment_start_time').clockpicker({
    ...
    $('.appointment_end_time').clockpicker({
    	...
    	$.ajax({
            ...
            data: { 'ajax_request' : 'yes','appointment_date' : appointment_date, 'appointment_start_time' : start_time, 'appointment_end_time' : end_time },
            type: 'POST',
            dataType: "json",
