...
<table class="table ">
	<thead class="first">
		<tr>
			...
			<th><?= get_label('category image');?></th>
...
<tr>
			...
			<td><img src="<?php echo media_url().$val['category_image'];?>" width="150" height="150"/></td>	
			...
			<a  href="<?php echo admin_url()."galleryitems/".encode_value($val['id']);?>" class="btn btn-success"><i class="fa fa-plus"
			title="<?php echo get_label('add menu items')?>"></i>&nbsp;<i class="fa fa-bars" aria-hidden="true"></i></a>
			</td>
		</tr>
<?php  } } else { ?>
<tr class="no_records" >
